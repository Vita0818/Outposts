# Kikaria v0.1 Specification (Windows)

## 1. Product Summary

Kikaria is a Windows app for assisted memorization.
...
- Use C# .NET 8.
- Use WinUI 3.
- Use local storage (JSON file in app data directory).
- Do not use third-party libraries in v0.1 except Microsoft.WindowsAppSDK.
- Do not add network features.
- Do not add login.
- Do not add cloud sync.
- Keep the project easy to build in Visual Studio 2022.