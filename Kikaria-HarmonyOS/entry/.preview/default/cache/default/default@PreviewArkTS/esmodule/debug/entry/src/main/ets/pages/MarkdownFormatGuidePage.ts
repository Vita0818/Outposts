...
export class MarkdownFormatGuideContent extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            NavDestination.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(32:5)", "entry");
        }, NavDestination);
        NavDestination.pop();
    }
    pageContent(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(42:5)", "entry");
            Scroll.width('100%');
            Scroll.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(43:7)", "entry");
            Column.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(44:9)", "entry");
            Row.width('100%');
            Row.padding({ left: 20, right: 20, top: 12, bottom: 12 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithChild();
            Button.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(45:11)", "entry");
            Button.backgroundColor(Color.Transparent);
            Button.onClick(() => { navPathStack.pop(); });
        }, Button);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('← 返回');
            Text.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(46:13)", "entry");
            Text.fontSize(17);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(53:11)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('Markdown 格式指南');
            Text.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(55:11)", "entry");
            Text.fontSize(17);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(63:9)", "entry");
            Text.fontSize(15);
            Text.fontColor(KikariaColors.DEEP_TEXT);
            Text.width('100%');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(68:9)", "entry");
            Column.width('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('基本结构');
            Text.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(69:11)", "entry");
            Text.fontSize(17);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(72:11)", "entry");
            Text.fontSize(13);
            Text.fontColor(KikariaColors.SOFT_TEXT);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 8 });
            Column.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(78:9)", "entry");
            Column.width('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('多个知识点');
            Text.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(79:11)", "entry");
            Text.fontSize(17);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(KikariaColors.DEEP_TEXT);
            Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(82:11)", "entry");
            Text.fontSize(15);
            Text.fontColor(KikariaColors.DEEP_TEXT);
            Text.width('100%');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`# 第一个知识点\ntags: 标签A\n\nhint:\n提示A\n\ncontent:\n答案A\n\n---\n\n# 第二个知识点\ntags: 标签B\n\nhint:\n提示B\n\ncontent:\n答案B`);
            Text.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(84:11)", "entry");
            Text.fontSize(13);
            Text.fontColor(KikariaColors.SOFT_TEXT);
            Text.backgroundColor(KikariaColors.MIST);
            Text.borderRadius(12);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 8 });
            Column.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(90:9)", "entry");
            Column.width('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('标签格式');
            Text.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(91:11)", "entry");
            Text.fontSize(17);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(KikariaColors.DEEP_TEXT);
            Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(94:11)", "entry");
            Text.fontSize(15);
            Text.fontColor(KikariaColors.DEEP_TEXT);
            Text.width('100%');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 8 });
            Column.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(98:9)", "entry");
            Column.width('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('数学公式');
            Text.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(99:11)", "entry");
            Text.fontSize(17);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(KikariaColors.DEEP_TEXT);
            Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(102:11)", "entry");
            Text.fontSize(15);
            Text.fontColor(KikariaColors.DEEP_TEXT);
            Text.width('100%');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 8 });
            Column.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(106:9)", "entry");
            Column.width('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('小贴士');
            Text.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(107:11)", "entry");
            Text.fontSize(17);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(KikariaColors.DEEP_TEXT);
            Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(110:11)", "entry");
            Text.fontSize(15);
            Text.fontColor(KikariaColors.DEEP_TEXT);
            Text.width('100%');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(114:9)", "entry");
            Row.height(40);
        }, Row);
        Row.pop();
        Column.pop();
...
class MarkdownFormatGuidePage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("entry/src/main/ets/pages/MarkdownFormatGuidePage.ets(131:5)", "entry");
