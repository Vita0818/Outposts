    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Stack.create();
                    Stack.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(74:7)", "entry");
                    Stack.width('100%');
                    Stack.height('100%');
                }, Stack);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(75:9)", "entry");
                    Column.width('100%');
                    Column.height('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(76:11)", "entry");
                    Row.width('100%');
                    Row.padding({ left: 20, right: 20, top: 12, bottom: 12 });
                }, Row);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Button.createWithChild();
                    Button.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(77:13)", "entry");
                    Button.backgroundColor(Color.Transparent);
                    Button.onClick(() => { navPathStack.pop(); });
                }, Button);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('← 返回');
                    Text.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(78:15)", "entry");
                    Text.fontSize(17);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(85:13)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(this.isNew ? '新建知识点' : '编辑知识点');
                    Text.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(87:13)", "entry");
                    Text.fontSize(17);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(92:13)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Button.createWithChild();
                    Button.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(94:13)", "entry");
                    Button.backgroundColor(Color.Transparent);
                    Button.onClick(() => { this.savePoint(); });
                }, Button);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('保存');
                    Text.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(95:15)", "entry");
                    Text.fontSize(15);
                    Text.fontWeight(FontWeight.Medium);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Scroll.create();
                    Scroll.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(106:11)", "entry");
                    Scroll.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(107:13)", "entry");
                    Column.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(109:15)", "entry");
                    // Title
                    Column.width('100%');
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('标题');
                    Text.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(110:17)", "entry");
                    Text.fontSize(13);
                    Text.fontWeight(FontWeight.Medium);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                    Text.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    TextInput.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(117:17)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // Tags
                    Column.create({ space: 6 });
                    Column.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(129:15)", "entry");
                    // Tags
                    Column.width('100%');
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('标签（逗号分隔）');
                    Text.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(130:17)", "entry");
                    Text.fontSize(13);
                    Text.fontWeight(FontWeight.Medium);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                    Text.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    TextInput.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(137:17)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // Hint
                    Column.create({ space: 6 });
                    Column.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(148:15)", "entry");
                    // Hint
                    Column.width('100%');
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('提示');
                    Text.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(149:17)", "entry");
                    Text.fontSize(13);
                    Text.fontWeight(FontWeight.Medium);
                    Text.fontColor(KikariaColors.SKY);
                    Text.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    TextArea.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(156:17)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // Content
                    Column.create({ space: 6 });
                    Column.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(168:15)", "entry");
                    // Content
                    Column.width('100%');
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('答案');
                    Text.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(169:17)", "entry");
                    Text.fontSize(13);
                    Text.fontWeight(FontWeight.Medium);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    TextArea.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(176:17)", "entry");
                    TextArea.fontSize(15);
                    TextArea.fontColor(KikariaColors.DEEP_TEXT);
                    TextArea.backgroundColor(KikariaColors.CARD_BG);
                    TextArea.borderRadius(14);
                    ...
                    if (!this.isNew) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Button.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(189:17)", "entry");
                                Button.fontSize(15);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(204:15)", "entry");
                    Row.height(40);
                }, Row);
                Row.pop();
                Column.pop();
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.showDeleteConfirm) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create();
                                Column.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(220:11)", "entry");
                                Column.width('100%');
                                Column.height('100%');
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Column.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(221:13)", "entry");
                                Column.width('80%');
                                Column.padding(24);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('删除知识点');
                                Text.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(222:15)", "entry");
                                Text.fontSize(17);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(227:15)", "entry");
                                Text.fontSize(14);
                                Text.fontColor(KikariaColors.SOFT_TEXT);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create({ space: 12 });
                                Row.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(232:15)", "entry");
                                Row.width('100%');
                            }, Row);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Button.createWithLabel('取消');
                                Button.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(233:17)", "entry");
                                Button.fontSize(15);
                                Button.fontWeight(FontWeight.Medium);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Button.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(240:17)", "entry");
                                Button.fontSize(15);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.toastVisible) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(272:11)", "entry");
                                Row.borderRadius(20);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(273:13)", "entry");
                                Text.fontSize(15);
            ...
            NavDestination.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(73:5)", "entry");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
...
class EditKnowledgePointPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("entry/src/main/ets/pages/EditKnowledgePointPage.ets(298:5)", "entry");
