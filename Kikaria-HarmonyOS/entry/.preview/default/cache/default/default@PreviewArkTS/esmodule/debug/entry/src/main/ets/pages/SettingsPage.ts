...
export class SettingsPageContent extends ViewPU {
    ...
    sectionHeader(label: string, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(label);
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(106:5)", "entry");
            Text.fontSize(13);
    ...
    profileRow(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 12 });
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(117:5)", "entry");
            Row.width('100%');
            Row.padding(16);
            Row.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(118:7)", "entry");
            Row.width(56);
            Row.height(56);
            Row.borderRadius(28);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(119:9)", "entry");
            Text.fontSize(28);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(130:7)", "entry");
            Column.alignItems(HorizontalAlign.Start);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.displayName);
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(131:9)", "entry");
            Text.fontSize(17);
            Text.fontWeight(FontWeight.Medium);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(136:9)", "entry");
            Text.fontSize(13);
            Text.fontColor(KikariaColors.SOFT_TEXT);
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/SettingsPage.ets(142:7)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('编辑 ›');
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(144:7)", "entry");
            Text.fontSize(14);
    ...
    landscapeProfileSummary(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(158:5)", "entry");
            Column.width('100%');
            Column.alignItems(HorizontalAlign.Center);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(159:7)", "entry");
            Row.width(72);
            Row.height(72);
            Row.borderRadius(36);
            Row.backgroundColor(KikariaColors.SKY);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.displayName.charAt(0).toUpperCase());
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(160:9)", "entry");
            Text.fontSize(42);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor('#FFFFFF');
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 4 });
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(171:7)", "entry");
            Column.alignItems(HorizontalAlign.Center);
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.displayName);
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(172:9)", "entry");
            Text.fontSize(24);
            Text.fontWeight(FontWeight.Bold);
            Text.fontColor(KikariaColors.DEEP_TEXT);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`@${this.userHandle}`);
            Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(178:9)", "entry");
            Text.fontSize(15);
            Text.fontColor(KikariaColors.SOFT_TEXT);
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/SettingsPage.ets(184:7)", "entry");
            Button.fontSize(16);
    ...
    overlayBackdrop(onDismiss: () => void, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(204:5)", "entry");
            Column.width('100%');
            Column.height('100%');
    ...
    pickerButtonRow(onCancel: () => void, onConfirm: () => void, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 12 });
            Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(214:5)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('取消');
            Button.debugLine("entry/src/main/ets/pages/SettingsPage.ets(215:7)", "entry");
            Button.fontSize(15);
            Button.fontWeight(FontWeight.Medium);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/SettingsPage.ets(225:7)", "entry");
            Button.fontSize(15);
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Stack.create();
                    Stack.debugLine("entry/src/main/ets/pages/SettingsPage.ets(240:7)", "entry");
                }, Stack);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Scroll.create();
                    Scroll.debugLine("entry/src/main/ets/pages/SettingsPage.ets(241:9)", "entry");
                    Scroll.width('100%');
                    Scroll.height('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(242:9)", "entry");
                    Column.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // Top bar
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(244:11)", "entry");
                    // Top bar
                    Row.width('100%');
                    // Top bar
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Button.debugLine("entry/src/main/ets/pages/SettingsPage.ets(245:13)", "entry");
                    Button.backgroundColor(Color.Transparent);
                    Button.onClick(() => { navPathStack.pop(); });
                }, Button);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('← 返回');
                    Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(246:15)", "entry");
                    Text.fontSize(17);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                }, Text);
                Text.pop();
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/SettingsPage.ets(253:13)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('设置');
                    Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(255:13)", "entry");
                    Text.fontSize(17);
                    Text.fontWeight(FontWeight.Medium);
                    Text.fontColor(KikariaColors.DEEP_TEXT);
                }, Text);
                    ...
                    if (this.useTwoColumn) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(264:13)", "entry");
                                Row.width('100%');
                                Row.constraintSize({ maxWidth: settingsLandscapeMaxWidth() });
                            }, Row);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create();
                                Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(265:15)", "entry");
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(272:15)", "entry");
                                Column.width(settingsLandscapeRightWidth());
                            }, Column);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // ── Daily Goal ──
                                Column.create({ space: 4 });
                                Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(274:17)", "entry");
                                // ── Daily Goal ──
                                Column.width('100%');
                            }, Column);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // ── Danger ──
                                Column.create({ space: 4 });
                                Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(289:17)", "entry");
                                // ── Danger ──
                                Column.width('100%');
                            }, Column);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // ── Countdown ──
                                Column.create({ space: 4 });
                                Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(304:17)", "entry");
                                // ── Countdown ──
                                Column.width('100%');
                            }, Column);
                                    ...
                                    if (isInitialRender) {
                                        let componentCall = new SettingsSectionCard(this, {
                                            content: () => {
                                                ...
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    Row.create({ space: 8 });
                                                    Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(309:21)", "entry");
                                                    Row.width('100%');
                                                    Row.padding({ left: 16, right: 16, top: 10, bottom: 14 });
                                                }, Row);
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    Button.createWithLabel('设置日期');
                                                    Button.debugLine("entry/src/main/ets/pages/SettingsPage.ets(310:23)", "entry");
                                                    Button.fontSize(14);
                                                    Button.fontWeight(FontWeight.Medium);
                                                    Button.fontColor('#FFFFFF');
                                                    Button.backgroundColor(KikariaColors.SKY);
                                                ...
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    ...
                                                    Button.debugLine("entry/src/main/ets/pages/SettingsPage.ets(311:23)", "entry");
                                                    Button.fontSize(14);
                                                    Button.fontWeight(FontWeight.Medium);
                                                    Button.fontColor(KikariaColors.SOFT_TEXT);
                                                    Button.backgroundColor(KikariaColors.MIST);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // ── Notifications ──
                                Column.create({ space: 4 });
                                Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(317:17)", "entry");
                                // ── Notifications ──
                                Column.width('100%');
                            }, Column);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // ── Appearance ──
                                Column.create({ space: 4 });
                                Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(329:17)", "entry");
                                // ── Appearance ──
                                Column.width('100%');
                            }, Column);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // ── About ──
                                Column.create({ space: 4 });
                                Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(337:17)", "entry");
                                // ── About ──
                                Column.width('100%');
                            }, Column);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(352:17)", "entry");
                                Row.height(40);
                            }, Row);
                            Row.pop();
                            Column.pop();
                        ...
                        this.ifElseBranchUpdateFunction(1, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // ── Profile ──
                                Column.create({ space: 4 });
                                Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(360:13)", "entry");
                                // ── Profile ──
                                Column.width('100%');
                            }, Column);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // ── Daily Goal ──
                                Column.create({ space: 4 });
                                Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(366:13)", "entry");
                                // ── Daily Goal ──
                                Column.width('100%');
                            }, Column);
                            this.sectionHeader.bind(this)('每日目标');
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // ── Danger ──
                                Column.create({ space: 4 });
                                Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(381:13)", "entry");
                                // ── Danger ──
                                Column.width('100%');
                            }, Column);
                            this.sectionHeader.bind(this)('预警阈值');
                                    ...
                                    if (isInitialRender) {
                                        let componentCall = new SettingsSectionCard(this, {
                                            content: () => {
                                                ...
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    Row.create({ space: 8 });
                                                    Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(401:17)", "entry");
                                                    Row.width('100%');
                                                    Row.padding({ left: 16, right: 16, top: 10, bottom: 14 });
                                                }, Row);
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    Button.createWithLabel('设置日期');
                                                    Button.debugLine("entry/src/main/ets/pages/SettingsPage.ets(402:19)", "entry");
                                                    Button.fontSize(14);
                                                    Button.fontWeight(FontWeight.Medium);
                                                    Button.fontColor('#FFFFFF');
                                                    Button.backgroundColor(KikariaColors.SKY);
                                                ...
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    Button.createWithLabel('清除');
                                                    Button.debugLine("entry/src/main/ets/pages/SettingsPage.ets(403:19)", "entry");
                                                    Button.fontSize(14);
                                                    Button.fontWeight(FontWeight.Medium);
                                                    Button.fontColor(KikariaColors.SOFT_TEXT);
                                                    Button.backgroundColor(KikariaColors.MIST);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // ── Notifications ──
                                Column.create({ space: 4 });
                                Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(409:13)", "entry");
                                // ── Notifications ──
                                Column.width('100%');
                            }, Column);
                            this.sectionHeader.bind(this)('通知');
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('Kikaria HarmonyOS · v1.0.0');
                                Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(440:13)", "entry");
                                Text.fontSize(12);
                                Text.fontColor(KikariaColors.TERTIARY_TEXT);
                                Text.width('100%');
                                Text.textAlign(TextAlign.Center);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(444:13)", "entry");
                                Row.height(40);
                            }, Row);
                            Row.pop();
                        });
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.showCountdownPicker) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Stack.create();
                                Stack.debugLine("entry/src/main/ets/pages/SettingsPage.ets(458:11)", "entry");
                                Stack.width('100%');
                                Stack.height('100%');
                            }, Stack);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create({ space: 16 });
                                Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(461:13)", "entry");
                                Column.width('80%');
                                Column.padding(24);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('设置截止日期');
                                Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(462:15)", "entry");
                                Text.fontSize(17);
                                Text.fontWeight(FontWeight.Bold);
                                Text.fontColor(KikariaColors.DEEP_TEXT);
                            }, Text);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create({ space: 8 });
                                Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(467:15)", "entry");
                            }, Row);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                TextInput.create({ text: `${this.pickerEndYear}` });
                                TextInput.debugLine("entry/src/main/ets/pages/SettingsPage.ets(468:17)", "entry");
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('/');
                                Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(480:17)", "entry");
                                Text.fontSize(20);
                                Text.fontColor(KikariaColors.TERTIARY_TEXT);
                            }, Text);
                            Text.pop();
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                TextInput.debugLine("entry/src/main/ets/pages/SettingsPage.ets(482:17)", "entry");
                                TextInput.fontSize(18);
                                TextInput.fontWeight(FontWeight.Bold);
                                TextInput.fontColor(KikariaColors.DEEP_TEXT);
                                TextInput.textAlign(TextAlign.Center);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('/');
                                Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(494:17)", "entry");
                                Text.fontSize(20);
                                Text.fontColor(KikariaColors.TERTIARY_TEXT);
                            }, Text);
                            Text.pop();
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                TextInput.debugLine("entry/src/main/ets/pages/SettingsPage.ets(496:17)", "entry");
                                TextInput.fontSize(18);
                                TextInput.fontWeight(FontWeight.Bold);
                                TextInput.fontColor(KikariaColors.DEEP_TEXT);
                                TextInput.textAlign(TextAlign.Center);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.showNotificationPicker) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Stack.create();
                                Stack.debugLine("entry/src/main/ets/pages/SettingsPage.ets(531:11)", "entry");
                                Stack.width('100%');
                                Stack.height('100%');
                            }, Stack);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create({ space: 16 });
                                Column.debugLine("entry/src/main/ets/pages/SettingsPage.ets(534:13)", "entry");
                                Column.width('80%');
                                Column.padding(24);
                                Column.borderRadius(20);
                                Column.backgroundColor(KikariaColors.CARD_BG);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('设置提醒时间');
                                Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(535:15)", "entry");
                                Text.fontSize(17);
                                Text.fontWeight(FontWeight.Bold);
                                Text.fontColor(KikariaColors.DEEP_TEXT);
                            }, Text);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create({ space: 8 });
                                Row.debugLine("entry/src/main/ets/pages/SettingsPage.ets(540:15)", "entry");
                            }, Row);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                TextInput.create({ text: `${String(this.pickerHour).padStart(2, '0')}` });
                                TextInput.debugLine("entry/src/main/ets/pages/SettingsPage.ets(541:17)", "entry");
                                TextInput.fontSize(18);
                                TextInput.fontWeight(FontWeight.Bold);
                                TextInput.fontColor(KikariaColors.DEEP_TEXT);
                                TextInput.textAlign(TextAlign.Center);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create(':');
                                Text.debugLine("entry/src/main/ets/pages/SettingsPage.ets(553:17)", "entry");
                                Text.fontSize(20);
                                Text.fontColor(KikariaColors.TERTIARY_TEXT);
                            }, Text);
                            Text.pop();
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                TextInput.debugLine("entry/src/main/ets/pages/SettingsPage.ets(555:17)", "entry");
                                TextInput.fontSize(18);
                                TextInput.fontWeight(FontWeight.Bold);
                                TextInput.fontColor(KikariaColors.DEEP_TEXT);
                                TextInput.textAlign(TextAlign.Center);
            ...
            NavDestination.debugLine("entry/src/main/ets/pages/SettingsPage.ets(239:5)", "entry");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
...
class SettingsPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("entry/src/main/ets/pages/SettingsPage.ets(600:5)", "entry");
