        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(30:7)", "entry");
                    Column.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // Top bar
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(32:9)", "entry");
                    // Top bar
                    Row.width('100%');
                    // Top bar
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Button.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(33:11)", "entry");
                    Button.backgroundColor(Color.Transparent);
                    Button.onClick(() => { navPathStack.pop(); });
                }, Button);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('取消');
                    Text.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(34:13)", "entry");
                    Text.fontSize(17);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(41:11)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('编辑资料');
                    Text.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(43:11)", "entry");
                    Text.fontSize(17);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(48:11)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Button.createWithChild();
                    Button.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(50:11)", "entry");
                    Button.backgroundColor(Color.Transparent);
                    Button.onClick(() => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('保存');
                    Text.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(51:13)", "entry");
                    Text.fontSize(17);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(76:9)", "entry");
                    // Avatar placeholder
                    Column.width('100%');
                    // Avatar placeholder
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(77:11)", "entry");
                    Row.width(80);
                    Row.height(80);
                    Row.borderRadius(40);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(78:13)", "entry");
                    Text.fontSize(40);
                    Text.fontWeight(FontWeight.Bold);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(89:11)", "entry");
                    Text.fontSize(12);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                }, Text);
                Text.pop();
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(97:9)", "entry");
                    // Name field
                    Column.width('100%');
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('显示名称');
                    Text.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(98:11)", "entry");
                    Text.fontSize(13);
                    Text.fontWeight(FontWeight.Medium);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                    Text.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    TextInput.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(104:11)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('用户标识');
                    Text.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(119:11)", "entry");
                    Text.fontSize(13);
                    Text.fontWeight(FontWeight.Medium);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                    Text.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    TextInput.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(125:11)", "entry");
                    TextInput.fontSize(17);
                    TextInput.fontColor(KikariaColors.DEEP_TEXT);
                    TextInput.backgroundColor(KikariaColors.CARD_BG);
                    TextInput.borderRadius(12);
            ...
            NavDestination.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(29:5)", "entry");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
...
class EditProfilePage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("entry/src/main/ets/pages/EditProfilePage.ets(153:5)", "entry");
