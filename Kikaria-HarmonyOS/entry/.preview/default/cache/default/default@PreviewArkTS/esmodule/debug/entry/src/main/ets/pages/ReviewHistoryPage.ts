    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(50:7)", "entry");
                    Column.width('100%');
                    Column.height('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(51:9)", "entry");
                    Row.width('100%');
                    Row.padding({ left: 20, right: 20, top: 12 + ipadPortraitListPageTopInset(), bottom: 12 });
                }, Row);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Button.createWithChild();
                    Button.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(52:11)", "entry");
                    Button.backgroundColor(Color.Transparent);
                    Button.onClick(() => { navPathStack.pop(); });
                }, Button);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('← 返回');
                    Text.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(53:13)", "entry");
                    Text.fontSize(17);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(60:11)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('复习历史');
                    Text.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(62:11)", "entry");
                    Text.fontSize(17);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(67:11)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(`${this.historyRecords.length}条`);
                    Text.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(69:11)", "entry");
                    Text.fontSize(13);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                }, Text);
                Text.pop();
                    ...
                    if (this.sortedDates.length === 0) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Column.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(77:11)", "entry");
                                Column.width('100%');
                                Column.height('100%');
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('暂无记录');
                                Text.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(78:13)", "entry");
                                Text.fontSize(20);
                                Text.fontWeight(FontWeight.Medium);
                                Text.fontColor(KikariaColors.DEEP_TEXT);
                            }, Text);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(82:13)", "entry");
                                Text.fontSize(15);
                                Text.fontColor(KikariaColors.SOFT_TEXT);
                            }, Text);
                            Text.pop();
                        ...
                        this.ifElseBranchUpdateFunction(1, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                List.create({ space: 0 });
                                List.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(90:11)", "entry");
                                List.width('100%');
                                ...
                                const forEachItemGenFunction = _item => {
                                    const dateKey = _item;
                                    {
                                        ...
                                        const itemCreation2 = (elmtId, isInitialRender) => {
                                            ListItem.create(deepRenderFunction, true);
                                            ListItem.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(92:15)", "entry");
                                        };
                                        const deepRenderFunction = (elmtId, isInitialRender) => {
                                            itemCreation(elmtId, isInitialRender);
                                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                Column.create({ space: 8 });
                                                Column.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(93:17)", "entry");
                                                Column.width('100%');
                                            ...
                                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                // Date header
                                                Row.create();
                                                Row.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(95:19)", "entry");
                                                // Date header
                                                Row.width('100%');
                                            }, Row);
                                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                Text.create(this.formatDate(parseInt(dateKey)));
                                                Text.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(96:21)", "entry");
                                                Text.fontSize(14);
                                                Text.fontWeight(FontWeight.Medium);
                                                Text.fontColor(KikariaColors.SOFT_TEXT);
                                            ...
                                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                ...
                                                const forEachItemGenFunction = _item => {
                                                    ...
                                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                        Row.create({ space: 10 });
                                                        Row.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(105:21)", "entry");
                                                        Row.width('100%');
                                                    ...
                                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                        ...
                                                        Text.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(106:23)", "entry");
                                                        Text.fontSize(14);
                                                    }, Text);
                                                    Text.pop();
                                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                        Text.create(record.pointTitle);
                                                        Text.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(109:23)", "entry");
                                                        Text.fontSize(14);
                                                        Text.fontColor(KikariaColors.DEEP_TEXT);
                                                        Text.layoutWeight(1);
                                                        Text.maxLines(1);
                                                    ...
                                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                        ...
                                                        Text.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(116:23)", "entry");
                                                        Text.fontSize(12);
                                                        Text.fontColor(KikariaColors.SOFT_TEXT);
                                                    }, Text);
                                                    Text.pop();
                                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                        ...
                                                        Text.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(120:23)", "entry");
                                                        Text.fontSize(12);
            ...
            NavDestination.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(49:5)", "entry");
        }, NavDestination);
        NavDestination.pop();
    }
...
class ReviewHistoryPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("entry/src/main/ets/pages/ReviewHistoryPage.ets(192:5)", "entry");
