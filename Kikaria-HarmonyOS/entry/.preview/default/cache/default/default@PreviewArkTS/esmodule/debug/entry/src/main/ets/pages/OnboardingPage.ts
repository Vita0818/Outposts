    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(28:7)", "entry");
                    Column.width('100%');
                    Column.height('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(29:9)", "entry");
                    Row.width('100%');
                    Row.padding({ left: 20, right: 20, top: 12, bottom: 12 });
                }, Row);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(30:11)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Button.createWithLabel('跳过');
                    Button.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(31:11)", "entry");
                    Button.fontSize(15);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // Page indicator
                    Row.create({ space: 8 });
                    Row.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(45:9)", "entry");
                    // Page indicator
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    const forEachItemGenFunction = _item => {
                        ...
                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                            Row.create();
                            Row.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(47:13)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.create();
                    Column.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(59:9)", "entry");
                    // Swipeable content area
                    Column.width('100%');
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.currentPage === 0) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Column.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(61:13)", "entry");
                                Column.width('100%');
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('📚');
                                Text.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(62:15)", "entry");
                                Text.fontSize(64);
                            }, Text);
                            Text.pop();
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('欢迎使用 Kikaria');
                                Text.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(65:15)", "entry");
                                Text.fontSize(28);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(71:15)", "entry");
                                Text.fontSize(16);
                        ...
                        this.ifElseBranchUpdateFunction(1, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create({ space: 20 });
                                Column.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(82:13)", "entry");
                                Column.width('100%');
                                Column.layoutWeight(1);
                                Column.justifyContent(FlexAlign.Center);
                            }, Column);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('🔄');
                                Text.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(83:15)", "entry");
                                Text.fontSize(64);
                            }, Text);
                            Text.pop();
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('间隔复习');
                                Text.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(86:15)", "entry");
                                Text.fontSize(28);
                                Text.fontWeight(FontWeight.Bold);
                                Text.fontColor(KikariaColors.DEEP_TEXT);
                                Text.fontFamily('serif');
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(92:15)", "entry");
                                Text.fontSize(16);
                                Text.fontColor(KikariaColors.SOFT_TEXT);
                                Text.textAlign(TextAlign.Center);
                                Text.lineHeight(26);
                        ...
                        this.ifElseBranchUpdateFunction(2, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create({ space: 20 });
                                Column.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(103:13)", "entry");
                                Column.width('100%');
                                Column.layoutWeight(1);
                                Column.justifyContent(FlexAlign.Center);
                            }, Column);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('📝');
                                Text.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(104:15)", "entry");
                                Text.fontSize(64);
                            }, Text);
                            Text.pop();
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('Markdown 预设');
                                Text.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(107:15)", "entry");
                                Text.fontSize(28);
                                Text.fontWeight(FontWeight.Bold);
                                Text.fontColor(KikariaColors.DEEP_TEXT);
                                Text.fontFamily('serif');
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(113:15)", "entry");
                                Text.fontSize(16);
                                Text.fontColor(KikariaColors.SOFT_TEXT);
                                Text.textAlign(TextAlign.Center);
                                Text.lineHeight(26);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // Navigation buttons
                    Row.create({ space: 16 });
                    Row.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(128:9)", "entry");
                    // Navigation buttons
                    Row.width('100%');
                    // Navigation buttons
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Button.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(129:11)", "entry");
                    Button.fontSize(15);
                    ...
                    if (this.currentPage < 2) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Button.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(142:13)", "entry");
                                Button.fontSize(15);
                                Button.fontWeight(FontWeight.Medium);
                        ...
                        this.ifElseBranchUpdateFunction(1, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Button.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(155:13)", "entry");
                                Button.fontSize(15);
            ...
            NavDestination.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(27:5)", "entry");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
...
class OnboardingPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("entry/src/main/ets/pages/OnboardingPage.ets(191:5)", "entry");
