    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(40:7)", "entry");
                    Column.width('100%');
                    Column.height('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // Top bar
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(42:9)", "entry");
                    // Top bar
                    Row.width('100%');
                    // Top bar
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Button.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(43:11)", "entry");
                    Button.backgroundColor(Color.Transparent);
                    Button.onClick(() => { navPathStack.pop(); });
                }, Button);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('← 返回');
                    Text.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(44:13)", "entry");
                    Text.fontSize(17);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(51:11)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('预设管理');
                    Text.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(53:11)", "entry");
                    Text.fontSize(17);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(58:11)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Button.createWithChild();
                    Button.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(60:11)", "entry");
                    Button.backgroundColor(Color.Transparent);
                    Button.onClick(() => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('+ 新建');
                    Text.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(61:13)", "entry");
                    Text.fontSize(15);
                    Text.fontWeight(FontWeight.Medium);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    List.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(74:9)", "entry");
                    List.width('100%');
                    ...
                    const forEachItemGenFunction = _item => {
                        const preset = _item;
                        {
                            ...
                            const itemCreation2 = (elmtId, isInitialRender) => {
                                ListItem.create(deepRenderFunction, true);
                                ListItem.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(76:13)", "entry");
                            };
                            const deepRenderFunction = (elmtId, isInitialRender) => {
                                itemCreation(elmtId, isInitialRender);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Column.create({ space: 6 });
                                    Column.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(77:15)", "entry");
                                    Column.width('100%');
                                    Column.padding(16);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Row.create({ space: 10 });
                                    Row.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(78:17)", "entry");
                                    Row.width('100%');
                                }, Row);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Column.create({ space: 4 });
                                    Column.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(79:19)", "entry");
                                    Column.layoutWeight(1);
                                    Column.alignItems(HorizontalAlign.Start);
                                }, Column);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Row.create({ space: 8 });
                                    Row.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(80:21)", "entry");
                                }, Row);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    If.create();
                                    if (this.currentPresetID === preset.id) {
                                        this.ifElseBranchUpdateFunction(0, () => {
                                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                Text.create('●');
                                                Text.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(82:25)", "entry");
                                                Text.fontSize(10);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(87:23)", "entry");
                                    Text.fontSize(17);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(93:21)", "entry");
                                    Text.fontSize(13);
                                    Text.fontColor(KikariaColors.SOFT_TEXT);
                                    Text.maxLines(2);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(103:19)", "entry");
                                    Text.fontSize(12);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Row.create({ space: 8 });
                                    Row.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(109:17)", "entry");
                                    Row.width('100%');
                                    Row.padding({ top: 8 });
                                }, Row);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    if (this.currentPresetID !== preset.id) {
                                        this.ifElseBranchUpdateFunction(0, () => {
                                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                ...
                                                Button.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(111:21)", "entry");
                                                Button.fontSize(14);
                                        ...
                                        this.ifElseBranchUpdateFunction(1, () => {
                                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                Text.create('当前');
                                                Text.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(130:21)", "entry");
                                                Text.fontSize(14);
                                                Text.fontColor(KikariaColors.MASTERED_GREEN);
                                            }, Text);
                                            Text.pop();
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Blank.create();
                                    Blank.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(135:19)", "entry");
                                }, Blank);
                                Blank.pop();
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Button.createWithLabel('编辑');
                                    Button.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(137:19)", "entry");
                                    Button.fontSize(13);
                                    Button.fontWeight(FontWeight.Medium);
                                    ...
                                    if (!preset.isBuiltIn && appState.presets.length > 1) {
                                        this.ifElseBranchUpdateFunction(0, () => {
                                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                ...
                                                Button.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(156:21)", "entry");
                                                Button.fontSize(13);
                                                Button.fontWeight(FontWeight.Medium);
            ...
            NavDestination.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(39:5)", "entry");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
...
class PresetSelectionPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("entry/src/main/ets/pages/PresetSelectionPage.ets(203:5)", "entry");
