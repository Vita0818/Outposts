    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Stack.create();
                    Stack.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(115:7)", "entry");
                    Stack.width('100%');
                    Stack.height('100%');
                }, Stack);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Scroll.create();
                    Scroll.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(116:9)", "entry");
                    Scroll.width('100%');
                    Scroll.height('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(117:11)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(118:13)", "entry");
                    Column.width('100%');
                    Column.alignItems(HorizontalAlign.Center);
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('欢迎使用 Kikaria');
                    Text.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(119:15)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(124:15)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(142:13)", "entry");
                    // Form fields
                    Column.width('100%');
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create({ space: 6 });
                    Column.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(143:15)", "entry");
                    Column.width('100%');
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('昵称');
                    Text.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(144:17)", "entry");
                    Text.fontSize(13);
                    Text.fontWeight(FontWeight.Medium);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                    Text.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    TextInput.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(151:17)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create({ space: 6 });
                    Column.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(164:15)", "entry");
                    Column.width('100%');
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('用户名');
                    Text.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(165:17)", "entry");
                    Text.fontSize(13);
                    Text.fontWeight(FontWeight.Medium);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                    Text.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    TextInput.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(172:17)", "entry");
                    TextInput.fontSize(17);
                    TextInput.fontColor(KikariaColors.DEEP_TEXT);
                    TextInput.backgroundColor(KikariaColors.CARD_BG_TRANSLUCENT);
                    TextInput.borderRadius(14);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Button.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(188:13)", "entry");
                    // Start button
                    Button.width('100%');
                    // Start button
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('开始使用');
                    Text.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(189:15)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.toastVisible) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(237:11)", "entry");
                                Row.borderRadius(20);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(238:13)", "entry");
                                Text.fontSize(15);
                                Text.fontColor('#FFFFFF');
            ...
            NavDestination.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(114:5)", "entry");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
...
class InitialProfileSetupPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("entry/src/main/ets/pages/InitialProfileSetupPage.ets(263:5)", "entry");
