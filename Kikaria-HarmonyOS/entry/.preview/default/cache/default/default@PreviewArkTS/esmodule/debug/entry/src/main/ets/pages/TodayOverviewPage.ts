    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Scroll.create();
                    Scroll.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(59:7)", "entry");
                    Scroll.width('100%');
                    Scroll.height('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(60:9)", "entry");
                    Column.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(61:11)", "entry");
                    Row.width('100%');
                    Row.padding({ left: 20, right: 20, top: 12 + ipadPortraitOverviewTopInset(), bottom: 12 });
                }, Row);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Button.createWithChild();
                    Button.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(62:13)", "entry");
                    Button.backgroundColor(Color.Transparent);
                    Button.onClick(() => { navPathStack.pop(); });
                }, Button);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('← 返回');
                    Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(63:15)", "entry");
                    Text.fontSize(17);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(70:13)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('今日概览');
                    Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(72:13)", "entry");
                    Text.fontSize(17);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(81:11)", "entry");
                    // Main progress card
                    Column.width('100%');
                    // Main progress card
                    Column.padding(24);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(82:13)", "entry");
                    Text.fontSize(48);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('今日掌握');
                    Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(88:13)", "entry");
                    Text.fontSize(15);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                }, Text);
                Text.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(92:13)", "entry");
                    Row.width('100%');
                    Row.height(6);
                    Row.borderRadius(3);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(93:15)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // Stats grid
                    Row.create({ space: 12 });
                    Row.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(115:11)", "entry");
                    // Stats grid
                    Row.width('100%');
                }, Row);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create({ space: 6 });
                    Column.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(116:13)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(117:15)", "entry");
                    Text.fontSize(28);
                    Text.fontWeight(FontWeight.Bold);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('总掌握');
                    Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(123:15)", "entry");
                    Text.fontSize(12);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                }, Text);
                Text.pop();
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create({ space: 6 });
                    Column.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(134:13)", "entry");
                    Column.layoutWeight(1);
                    Column.padding(16);
                    Column.borderRadius(18);
                    Column.backgroundColor(KikariaColors.CARD_BG_TRANSLUCENT);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(135:15)", "entry");
                    Text.fontSize(28);
                    Text.fontWeight(FontWeight.Bold);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('查看提示');
                    Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(141:15)", "entry");
                    Text.fontSize(12);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                }, Text);
                Text.pop();
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create({ space: 6 });
                    Column.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(152:13)", "entry");
                    Column.layoutWeight(1);
                    Column.padding(16);
                    Column.borderRadius(18);
                    Column.backgroundColor(KikariaColors.CARD_BG_TRANSLUCENT);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(153:15)", "entry");
                    Text.fontSize(28);
                    Text.fontWeight(FontWeight.Bold);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('查看答案');
                    Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(159:15)", "entry");
                    Text.fontSize(12);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                }, Text);
                Text.pop();
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(173:11)", "entry");
                    // Countdown card
                    Column.width('100%');
                    // Countdown card
                    Column.padding(20);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('倒计时');
                    Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(174:13)", "entry");
                    Text.fontSize(15);
                    Text.fontWeight(FontWeight.Medium);
                    Text.fontColor(KikariaColors.DEEP_TEXT);
                    Text.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create({ space: 16 });
                    Row.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(180:13)", "entry");
                }, Row);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(this.countdownDays);
                    Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(181:15)", "entry");
                    Text.fontSize(28);
                    Text.fontWeight(FontWeight.Bold);
                    Text.fontColor(KikariaColors.DEEP_TEXT);
                    Text.fontFamily('serif');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(187:15)", "entry");
                    Text.fontSize(13);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                }, Text);
                Text.pop();
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.recentActivity.length > 0) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create({ space: 8 });
                                Column.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(201:13)", "entry");
                                Column.width('100%');
                                Column.padding(20);
                                Column.borderRadius(18);
                                Column.backgroundColor(KikariaColors.CARD_BG_TRANSLUCENT);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('今日活动');
                                Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(202:15)", "entry");
                                Text.fontSize(15);
                                Text.fontWeight(FontWeight.Medium);
                                Text.fontColor(KikariaColors.DEEP_TEXT);
                                Text.width('100%');
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                const forEachItemGenFunction = _item => {
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create({ space: 12 });
                                        Row.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(209:17)", "entry");
                                        Row.width('100%');
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(210:19)", "entry");
                                        Text.fontSize(16);
                                    }, Text);
                                    Text.pop();
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create(record.pointTitle);
                                        Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(213:19)", "entry");
                                        Text.fontSize(14);
                                        Text.fontColor(KikariaColors.DEEP_TEXT);
                                        Text.layoutWeight(1);
                                        Text.maxLines(1);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Text.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(220:19)", "entry");
                                        Text.fontSize(12);
                                        Text.fontColor(KikariaColors.SOFT_TEXT);
                                    }, Text);
                                    Text.pop();
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(237:11)", "entry");
                    Row.width('100%');
                    Row.padding({ top: 8 });
                }, Row);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Button.createWithLabel('查看历史记录 →');
                    Button.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(238:13)", "entry");
                    Button.fontSize(15);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(250:11)", "entry");
                    Row.height(40);
                }, Row);
                Row.pop();
                Column.pop();
            ...
            NavDestination.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(58:5)", "entry");
        }, NavDestination);
        NavDestination.pop();
    }
...
class TodayOverviewPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("entry/src/main/ets/pages/TodayOverviewPage.ets(293:5)", "entry");
