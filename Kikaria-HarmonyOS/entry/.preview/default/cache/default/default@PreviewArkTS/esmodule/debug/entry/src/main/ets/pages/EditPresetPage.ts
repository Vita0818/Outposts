    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            NavDestination.create(() => {
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Stack.create();
                    Stack.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(76:7)", "entry");
                    Stack.width('100%');
                    Stack.height('100%');
                }, Stack);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create();
                    Column.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(77:9)", "entry");
                    Column.width('100%');
                    Column.height('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // Top bar
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(79:11)", "entry");
                    // Top bar
                    Row.width('100%');
                    // Top bar
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Button.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(80:13)", "entry");
                    Button.backgroundColor(Color.Transparent);
                    Button.onClick(() => { navPathStack.pop(); });
                }, Button);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('← 返回');
                    Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(81:15)", "entry");
                    Text.fontSize(17);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(88:13)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('编辑预设');
                    Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(90:13)", "entry");
                    Text.fontSize(17);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(95:13)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Button.createWithChild();
                    Button.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(97:13)", "entry");
                    Button.backgroundColor(Color.Transparent);
                    Button.onClick(() => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('保存');
                    Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(98:15)", "entry");
                    Text.fontSize(15);
                    Text.fontWeight(FontWeight.Medium);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Scroll.create();
                    Scroll.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(116:11)", "entry");
                    Scroll.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(117:13)", "entry");
                    Column.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Column.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(119:15)", "entry");
                    // Preset name
                    Column.width('100%');
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('预设名称');
                    Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(120:17)", "entry");
                    Text.fontSize(13);
                    Text.fontWeight(FontWeight.Medium);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                    Text.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    TextInput.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(127:17)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // Preset description
                    Column.create({ space: 6 });
                    Column.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(141:15)", "entry");
                    // Preset description
                    Column.width('100%');
                }, Column);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('描述');
                    Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(142:17)", "entry");
                    Text.fontSize(13);
                    Text.fontWeight(FontWeight.Medium);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                    Text.width('100%');
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    TextInput.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(149:17)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(163:15)", "entry");
                    // Knowledge points header with search
                    Row.width('100%');
                    // Knowledge points header with search
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(164:17)", "entry");
                    Text.fontSize(13);
                    Text.fontWeight(FontWeight.Medium);
                    Text.fontColor(KikariaColors.SOFT_TEXT);
                }, Text);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Blank.create();
                    Blank.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(169:17)", "entry");
                }, Blank);
                Blank.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    If.create();
                    if (this.knowledgePoints.length > 0) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Button.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(172:19)", "entry");
                                Button.fontSize(13);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    // Search bar
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(194:15)", "entry");
                    // Search bar
                    Row.width('100%');
                    // Search bar
                    Row.padding(14);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('🔍');
                    Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(195:17)", "entry");
                    Text.fontSize(14);
                }, Text);
                Text.pop();
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    TextInput.create({ text: this.searchQuery, placeholder: '搜索知识点标题或标签...' });
                    TextInput.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(197:17)", "entry");
                    TextInput.fontSize(15);
                    TextInput.fontColor(KikariaColors.DEEP_TEXT);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.searchQuery.length > 0) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('✕');
                                Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(206:19)", "entry");
                                Text.fontSize(14);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(219:15)", "entry");
                    // Create new knowledge point button
                    Row.width('100%');
                    // Create new knowledge point button
                    Row.height(48);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('+ 新建知识点');
                    Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(220:17)", "entry");
                    Text.fontSize(15);
                    Text.fontWeight(FontWeight.Medium);
                    Text.fontColor(KikariaColors.SKY);
                }, Text);
                    ...
                    if (this.filteredPoints.length === 0) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Column.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(237:17)", "entry");
                                Column.width('100%');
                                Column.padding(30);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(238:19)", "entry");
                                Text.fontSize(15);
                                Text.fontColor(KikariaColors.SOFT_TEXT);
                            }, Text);
                            Text.pop();
                        ...
                        this.ifElseBranchUpdateFunction(1, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                const forEachItemGenFunction = _item => {
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Column.create({ space: 8 });
                                        Column.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(250:19)", "entry");
                                        Column.width('100%');
                                        Column.padding(14);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create({ space: 8 });
                                        Row.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(251:21)", "entry");
                                        Row.width('100%');
                                        Row.onClick(() => {
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Column.create({ space: 6 });
                                        Column.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(252:23)", "entry");
                                        Column.layoutWeight(1);
                                        Column.alignItems(HorizontalAlign.Start);
                                    }, Column);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create({ space: 8 });
                                        Row.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(253:25)", "entry");
                                    }, Row);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create(kp.title);
                                        Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(254:27)", "entry");
                                        Text.fontSize(15);
                                        Text.fontWeight(FontWeight.Medium);
                                        Text.fontColor(KikariaColors.DEEP_TEXT);
                                        Text.maxLines(2);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        if (kp.isMastered) {
                                            this.ifElseBranchUpdateFunction(0, () => {
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    Text.create('✓');
                                                    Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(263:29)", "entry");
                                                    Text.fontSize(12);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        if (kp.isReinforced) {
                                            this.ifElseBranchUpdateFunction(0, () => {
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    Text.create('★');
                                                    Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(269:29)", "entry");
                                                    Text.fontSize(12);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        if (kp.tags.length > 0) {
                                            this.ifElseBranchUpdateFunction(0, () => {
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    Row.create({ space: 6 });
                                                    Row.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(276:27)", "entry");
                                                }, Row);
                                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                    ForEach.create();
                                                    const forEachItemGenFunction = _item => {
                                                        ...
                                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                            Text.create(tag);
                                                            Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(278:31)", "entry");
                                                            Text.fontSize(10);
                                                            Text.fontColor(KikariaColors.SOFT_TEXT);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Button.createWithChild();
                                        Button.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(291:23)", "entry");
                                        Button.width(32);
                                        Button.height(32);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create('✕');
                                        Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(292:25)", "entry");
                                        Text.fontSize(14);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Divider.create();
                                        Divider.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(311:21)", "entry");
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (!appState.currentPreset.isBuiltIn && appState.presets.length > 1) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create();
                                Column.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(326:17)", "entry");
                                Column.width('100%');
                            }, Column);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Button.createWithLabel('删除此预设');
                                Button.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(327:19)", "entry");
                                Button.fontSize(15);
                                Button.fontWeight(FontWeight.Medium);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(343:15)", "entry");
                    Row.height(40);
                }, Row);
                Row.pop();
                Column.pop();
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.showDeletePresetConfirm) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create();
                                Column.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(359:11)", "entry");
                                Column.width('100%');
                                Column.height('100%');
                                Column.justifyContent(FlexAlign.Center);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Column.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(360:13)", "entry");
                                Column.width('80%');
                                Column.padding(24);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('删除预设');
                                Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(361:15)", "entry");
                                Text.fontSize(17);
                                Text.fontWeight(FontWeight.Bold);
                                Text.fontColor(KikariaColors.DEEP_TEXT);
                            }, Text);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(366:15)", "entry");
                                Text.fontSize(14);
                                Text.fontColor(KikariaColors.SOFT_TEXT);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create({ space: 12 });
                                Row.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(371:15)", "entry");
                                Row.width('100%');
                            }, Row);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Button.createWithLabel('取消');
                                Button.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(372:17)", "entry");
                                Button.fontSize(15);
                                Button.fontWeight(FontWeight.Medium);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Button.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(384:17)", "entry");
                                Button.fontSize(15);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    if (this.toastVisible) {
                        this.ifElseBranchUpdateFunction(0, () => {
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(421:11)", "entry");
                                Row.borderRadius(20);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(422:13)", "entry");
                                Text.fontSize(15);
            ...
            NavDestination.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(75:5)", "entry");
        }, NavDestination);
        NavDestination.pop();
    }
    rerender() {
...
class EditPresetPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Navigation.debugLine("entry/src/main/ets/pages/EditPresetPage.ets(447:5)", "entry");
