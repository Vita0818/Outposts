...
export class LiquidGlassCard extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/KikariaComponents.ets(41:5)", "entry");
            Column.width('100%');
...
export class LiquidGlassCapsule extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/KikariaComponents.ets(65:5)", "entry");
...
export class LiquidGlassCircle extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/components/KikariaComponents.ets(87:5)", "entry");
...
export class SettingsSectionCard extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/components/KikariaComponents.ets(137:5)", "entry");
            Column.width('100%');
...
export class SettingsSectionDivider extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/KikariaComponents.ets(156:5)", "entry");
            Row.width('100%');
            Row.height(0.5);
...
export class SettingsListRow extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/KikariaComponents.ets(175:5)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/KikariaComponents.ets(176:7)", "entry");
            Text.fontSize(15);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/components/KikariaComponents.ets(180:7)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
            if (this.value.length > 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/components/KikariaComponents.ets(183:9)", "entry");
                        Text.fontSize(15);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.showArrow) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('›');
                        Text.debugLine("entry/src/main/ets/components/KikariaComponents.ets(191:9)", "entry");
                        Text.fontSize(16);
...
export class SettingsToggleRow extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/KikariaComponents.ets(210:5)", "entry");
            Row.width('100%');
            Row.padding({ left: 16, right: 16, top: 14, bottom: 14 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.label);
            Text.debugLine("entry/src/main/ets/components/KikariaComponents.ets(211:7)", "entry");
            Text.fontSize(15);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/components/KikariaComponents.ets(215:7)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Toggle.create({ type: ToggleType.Switch, isOn: this.isOn });
            Toggle.debugLine("entry/src/main/ets/components/KikariaComponents.ets(217:7)", "entry");
...
export class SettingsInfoTextRow extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/KikariaComponents.ets(233:5)", "entry");
            Text.fontSize(12);
            Text.fontColor(KikariaColors.TERTIARY_TEXT);
            Text.width('100%');
...
export class SettingsStepperRow extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/KikariaComponents.ets(253:5)", "entry");
            Row.width('100%');
            Row.padding({ left: 16, right: 16, top: 14, bottom: 14 });
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.label);
            Text.debugLine("entry/src/main/ets/components/KikariaComponents.ets(254:7)", "entry");
            Text.fontSize(15);
            Text.fontColor(KikariaColors.DEEP_TEXT);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/components/KikariaComponents.ets(258:7)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 8 });
            Row.debugLine("entry/src/main/ets/components/KikariaComponents.ets(260:7)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('-');
            Button.debugLine("entry/src/main/ets/components/KikariaComponents.ets(261:9)", "entry");
            Button.fontSize(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(`${this.value}`);
            Text.debugLine("entry/src/main/ets/components/KikariaComponents.ets(270:9)", "entry");
            Text.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithLabel('+');
            Button.debugLine("entry/src/main/ets/components/KikariaComponents.ets(277:9)", "entry");
            Button.fontSize(20);
            Button.fontWeight(FontWeight.Bold);
            Button.fontColor(KikariaColors.SKY);
            Button.width(36);
...
export class KikariaButton extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/components/KikariaComponents.ets(302:5)", "entry");
...
export class TagChip extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.label);
            Text.debugLine("entry/src/main/ets/components/KikariaComponents.ets(360:5)", "entry");
            Text.fontSize(12);
            Text.fontWeight(FontWeight.Medium);
...
export class FloatingInfoCard extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/components/KikariaComponents.ets(379:5)", "entry");
            Column.width('100%');
            Column.padding(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.label);
            Text.debugLine("entry/src/main/ets/components/KikariaComponents.ets(380:7)", "entry");
            Text.fontSize(13);
            Text.fontWeight(FontWeight.Medium);
            Text.fontColor(this.labelColor);
            Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.text);
            Text.debugLine("entry/src/main/ets/components/KikariaComponents.ets(386:7)", "entry");
            Text.fontSize(15);
            Text.fontColor(KikariaColors.DEEP_TEXT);
            Text.width('100%');
...
export class ProfileAvatar extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/components/KikariaComponents.ets(415:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/KikariaComponents.ets(416:7)", "entry");
...
export class DashboardMetricColumn extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/components/KikariaComponents.ets(443:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/KikariaComponents.ets(444:7)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/components/KikariaComponents.ets(450:7)", "entry");
            Text.fontSize(13);
...
export class AdaptiveBackButton extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/components/KikariaComponents.ets(467:5)", "entry");
            Button.backgroundColor(Color.Transparent);
            Button.onClick(() => this.onTap());
        }, Button);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.label);
            Text.debugLine("entry/src/main/ets/components/KikariaComponents.ets(468:7)", "entry");
            Text.fontSize(17);
            Text.fontColor(KikariaColors.SOFT_TEXT);
        }, Text);
        Text.pop();
