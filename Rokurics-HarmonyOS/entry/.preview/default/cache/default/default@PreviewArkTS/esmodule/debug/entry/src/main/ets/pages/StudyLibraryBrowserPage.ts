...
class StudyLibraryBrowserPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(157:5)", "entry");
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // Header
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(160:7)", "entry");
            // Header
            Row.width('100%');
            // Header
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(161:9)", "entry");
            Button.width(44);
            Button.height(44);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('←');
            Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(162:11)", "entry");
            Text.fontSize(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('学习库浏览');
            Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(167:9)", "entry");
            Text.fontSize(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // Breadcrumb
            Row.create({ space: 4 });
            Row.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(175:7)", "entry");
            // Breadcrumb
            Row.width('100%');
            // Breadcrumb
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = (_item, index: number) => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Row.create();
                    Row.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(177:11)", "entry");
                    Row.onClick(() => {
                        if (index === 0) {
                            this.navigateTo([]);
                        }
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(crumb);
                    Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(178:13)", "entry");
                    Text.fontSize(13);
            ...
            if (this.breadcrumb.length > 1) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(194:11)", "entry");
                        Text.fontSize(12);
            ...
            if (this.allRecordings.length === 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(202:9)", "entry");
                        Column.width('100%');
                        Column.height('60%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('暂无已归档录音');
                        Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(203:11)", "entry");
                        Text.fontSize(16);
                        Text.fontColor(RokuricsColors.tertiaryText);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(204:11)", "entry");
                        Text.fontSize(13);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Row.create();
                        Row.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(209:9)", "entry");
                        // Create folder button
                        Row.width('100%');
                        // Create folder button
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Blank.create();
                        Blank.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(210:11)", "entry");
                    }, Blank);
                    Blank.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild();
                        Button.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(211:11)", "entry");
                        Button.backgroundColor(Color.Transparent);
                        Button.onClick(() => {
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('+ 新建分类');
                        Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(212:13)", "entry");
                        Text.fontSize(13);
                        ...
                        if (this.showCreateFolder) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Column.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(226:11)", "entry");
                                    Column.width('90%');
                                    Column.padding(14);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Row.create();
                                    Row.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(227:13)", "entry");
                                    Row.width('100%');
                                }, Row);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('新建分类');
                                    Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(228:15)", "entry");
                                    Text.fontSize(14);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Blank.create();
                                    Blank.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(230:15)", "entry");
                                }, Blank);
                                Blank.pop();
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Button.createWithChild();
                                    Button.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(231:15)", "entry");
                                    Button.width(32);
                                    Button.height(32);
                                    Button.backgroundColor(Color.Transparent);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('✕');
                                    Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(231:26)", "entry");
                                    Text.fontSize(14);
                                    Text.fontColor(RokuricsColors.softText);
                                }, Text);
                                Text.pop();
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Row.create({ space: 6 });
                                    Row.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(236:13)", "entry");
                                }, Row);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ForEach.create();
                                    const forEachItemGenFunction = _item => {
                                        ...
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            ...
                                            Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(238:17)", "entry");
                                            Text.fontSize(12);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    // Color chips
                                    Row.create({ space: 6 });
                                    Row.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(249:13)", "entry");
                                }, Row);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('颜色');
                                    Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(250:15)", "entry");
                                    Text.fontSize(12);
                                    Text.fontColor(RokuricsColors.softText);
                                    Text.margin({ right: 4 });
                                }, Text);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    const forEachItemGenFunction = _item => {
                                        ...
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            Row.create();
                                            Row.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(252:17)", "entry");
                                            Row.width(24);
                                            Row.height(24);
                                            Row.borderRadius(12);
                                        ...
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            ...
                                            if (this.newFolderColor === color) {
                                                this.ifElseBranchUpdateFunction(0, () => {
                                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                                        Text.create('✓');
                                                        Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(254:21)", "entry");
                                                        Text.fontSize(10);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Row.create({ space: 8 });
                                    Row.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(265:13)", "entry");
                                    Row.width('100%');
                                }, Row);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    TextInput.create({ text: this.newFolderName, placeholder: '分类名称' });
                                    TextInput.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(266:15)", "entry");
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Button.createWithChild();
                                    Button.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(272:15)", "entry");
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Text.create('创建');
                                    Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(273:17)", "entry");
                                    Text.fontSize(13);
                                    Text.fontColor(Color.White);
                                }, Text);
                                Text.pop();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // Group view - show filing categories
                        List.create({ space: 8 });
                        List.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(290:9)", "entry");
                        // Group view - show filing categories
                        List.width('100%');
                        // Group view - show filing categories
                        List.layoutWeight(1);
                        ...
                        const forEachItemGenFunction = _item => {
                            const group = _item;
                            {
                                ...
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ListItem.create(deepRenderFunction, true);
                                    ListItem.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(292:13)", "entry");
                                };
                                const deepRenderFunction = (elmtId, isInitialRender) => {
                                    itemCreation(elmtId, isInitialRender);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Row.create();
                                        Row.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(293:15)", "entry");
                                        Row.width('100%');
                                        Row.padding(16);
                                        Row.borderRadius(14);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Column.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(294:17)", "entry");
                                        Column.layoutWeight(1);
                                        Column.alignItems(HorizontalAlign.Start);
                                    }, Column);
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create(group.label);
                                        Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(295:19)", "entry");
                                        Text.fontSize(16);
                                        Text.fontWeight(FontWeight.SemiBold);
                                        Text.fontColor(RokuricsColors.deepText);
                                    }, Text);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(298:19)", "entry");
                                        Text.fontSize(12);
                                        Text.fontColor(RokuricsColors.tertiaryText);
                                    }, Text);
                                    Text.pop();
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        ...
                                        Button.createWithChild();
                                        Button.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(304:17)", "entry");
                                        // Context menu for folder actions
                                        Button.width(32);
                                        // Context menu for folder actions
                                        Button.height(32);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create('…');
                                        Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(305:19)", "entry");
                                        Text.fontSize(18);
                                        Text.fontColor(RokuricsColors.softText);
                                        Text.fontWeight(FontWeight.Bold);
                                    }, Text);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Button.createWithChild();
                                        Button.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(316:17)", "entry");
                                        Button.width(32);
                                        Button.height(32);
                                        Button.backgroundColor(Color.Transparent);
                                        Button.onClick(() => {
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create('✕');
                                        Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(317:19)", "entry");
                                        Text.fontSize(14);
                                    ...
                                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                                        Text.create('›');
                                        Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(326:17)", "entry");
                                        Text.fontSize(22);
                                        Text.fontColor(RokuricsColors.softText);
                                    }, Text);
                                    Text.pop();
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        if (this.unfiledCount > 0) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Row.create();
                                    Row.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(347:11)", "entry");
                                    Row.width('100%');
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(348:13)", "entry");
                                    Text.fontSize(15);
                                    Text.fontWeight(FontWeight.SemiBold);
                                    Text.fontColor(RokuricsColors.deepText);
                                }, Text);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    List.create({ space: 6 });
                                    List.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(358:11)", "entry");
                                    List.width('100%');
                                    List.layoutWeight(1);
                                    List.padding({ left: 16, right: 16 });
                                    List.scrollBar(BarState.Off);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    const forEachItemGenFunction = _item => {
                                        const recording = _item;
                                        {
                                            ...
                                            const itemCreation2 = (elmtId, isInitialRender) => {
                                                ListItem.create(deepRenderFunction, true);
                                                ListItem.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(360:15)", "entry");
                                            };
                                            const deepRenderFunction = (elmtId, isInitialRender) => {
                                                itemCreation(elmtId, isInitialRender);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        if (this.showRecordings.length === 0) {
                            this.ifElseBranchUpdateFunction(0, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    Column.create({ space: 12 });
                                    Column.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(369:11)", "entry");
                                    Column.width('100%');
                                    Column.height('60%');
                                    Column.justifyContent(FlexAlign.Center);
                                }, Column);
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    Text.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(370:13)", "entry");
                                    Text.fontSize(16);
                                    Text.fontColor(RokuricsColors.tertiaryText);
                                }, Text);
                                Text.pop();
                            ...
                            this.ifElseBranchUpdateFunction(1, () => {
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    List.create({ space: 6 });
                                    List.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(374:11)", "entry");
                                    List.width('100%');
                                    List.layoutWeight(1);
                                    List.padding({ left: 16, right: 16 });
                                    List.scrollBar(BarState.Off);
                                ...
                                this.observeComponentCreation2((elmtId, isInitialRender) => {
                                    ...
                                    const forEachItemGenFunction = _item => {
                                        const recording = _item;
                                        {
                                            ...
                                            const itemCreation2 = (elmtId, isInitialRender) => {
                                                ListItem.create(deepRenderFunction, true);
                                                ListItem.debugLine("entry/src/main/ets/pages/StudyLibraryBrowserPage.ets(376:15)", "entry");
                                            };
                                            const deepRenderFunction = (elmtId, isInitialRender) => {
                                                itemCreation(elmtId, isInitialRender);
                                                this.RecordingRow.bind(this)(recording);
