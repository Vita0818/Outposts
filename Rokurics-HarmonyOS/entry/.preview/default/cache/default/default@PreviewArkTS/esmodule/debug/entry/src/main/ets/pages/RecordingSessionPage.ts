...
class RecordingSessionPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(77:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(81:7)", "entry");
            Column.width('100%');
            Column.height('100%');
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // Header
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(83:9)", "entry");
            // Header
            Row.width('100%');
            // Header
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(85:11)", "entry");
            // Glass circle back button
            Button.width(44);
            // Glass circle back button
            Button.height(44);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('←');
            Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(86:13)", "entry");
            Text.fontSize(18);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(114:11)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
            ...
            if (this.state === RecordingState.RECORDING || this.state === RecordingState.PAUSED) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild();
                        Button.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(118:13)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('停止');
                        Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(119:15)", "entry");
                        Text.fontSize(16);
                        Text.fontWeight(FontWeight.SemiBold);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild();
                        Button.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(136:13)", "entry");
                        Button.padding({ left: 20, right: 20, top: 10, bottom: 10 });
                        Button.borderRadius(20);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('保存');
                        Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(137:15)", "entry");
                        Text.fontSize(16);
                        Text.fontWeight(FontWeight.SemiBold);
                        Text.fontColor(Color.White);
                    }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(163:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // Timer card with glass styling (mirrors Apple's liquid glass card)
            Column.create({ space: 16 });
            Column.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(166:9)", "entry");
            // Timer card with glass styling (mirrors Apple's liquid glass card)
            Column.width('85%');
            // Timer card with glass styling (mirrors Apple's liquid glass card)
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(167:11)", "entry");
            Text.fontSize(78);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(175:11)", "entry");
            Text.fontSize(15);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.state === RecordingState.RECORDING) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create({ space: 6 });
                        Row.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(182:13)", "entry");
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Circle.create();
                        Circle.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(183:15)", "entry");
                        Circle.width(8);
                        Circle.height(8);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('录制中');
                        Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(188:15)", "entry");
                        Text.fontSize(12);
            ...
            if (this.state === RecordingState.FAILED) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(195:13)", "entry");
                        Text.fontSize(13);
                        Text.fontColor(RokuricsColors.coral);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Blank.create();
            Blank.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(225:9)", "entry");
        }, Blank);
        Blank.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            If.create();
            ...
            if (this.state === RecordingState.RECORDING || this.state === RecordingState.PAUSED) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create({ space: 12 });
                        Row.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(229:11)", "entry");
                        Row.width('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // Pause/Resume button
                        Button.createWithChild();
                        Button.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(231:13)", "entry");
                        // Pause/Resume button
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(232:15)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(238:17)", "entry");
                        Text.fontSize(13);
                        Text.fontWeight(FontWeight.SemiBold);
                    }, Text);
                    Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.state === RecordingState.RECORDING || this.state === RecordingState.PAUSED) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild();
                        Button.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(276:11)", "entry");
                        Button.width(72);
                        Button.height(72);
            ...
            if (this.state === RecordingState.SAVED) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(306:9)", "entry");
                    }, Column);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('已保存');
                        Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(307:11)", "entry");
                        Text.fontSize(24);
                        Text.fontWeight(FontWeight.Bold);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(311:11)", "entry");
                        Text.fontSize(14);
                        Text.fontColor(RokuricsColors.softText);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild();
                        Button.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(314:11)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('返回首页');
                        Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(315:13)", "entry");
                        Text.fontWeight(FontWeight.Medium);
                        Text.fontColor(RokuricsColors.aqua);
                    }, Text);
                    Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.state === RecordingState.FAILED) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create({ space: 12 });
                        Column.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(328:9)", "entry");
                    }, Column);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('录音失败');
                        Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(329:11)", "entry");
                        Text.fontSize(18);
                        Text.fontColor(RokuricsColors.coral);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(332:11)", "entry");
                        Text.fontSize(13);
                        Text.fontColor(RokuricsColors.softText);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithChild();
                        Button.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(335:11)", "entry");
                        Button.margin({ top: 16 });
                        Button.onClick(() => this.getUIContext().getRouter().back());
                    }, Button);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('返回');
                        Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(336:13)", "entry");
                        Text.fontColor(RokuricsColors.aqua);
                    }, Text);
                    Text.pop();
                    Button.pop();
    ...
    FilingOverlay(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(351:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
            Stack.zIndex(10);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(353:7)", "entry");
            // Semi-transparent backdrop
            Column.width('100%');
            // Semi-transparent backdrop
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // Filing card overlay
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(360:7)", "entry");
            // Filing card overlay
            Scroll.width('100%');
            // Filing card overlay
            Scroll.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 16 });
            Column.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(361:9)", "entry");
            Column.width('100%');
            Column.padding(22);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // Header
            Text.create('录音归档');
            Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(363:11)", "entry");
            // Header
            Text.fontSize(30);
            // Header
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(368:11)", "entry");
            Text.fontSize(14);
            Text.fontColor(RokuricsColors.softText);
        }, Text);
        Text.pop();
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // Title input
            Column.create({ space: 8 });
            Column.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(373:11)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('录音标题');
            Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(374:13)", "entry");
            Text.fontSize(13);
            Text.fontWeight(FontWeight.SemiBold);
            Text.fontColor(RokuricsColors.softText);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextInput.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(378:13)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Row.create({ space: 8 });
            Row.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(396:11)", "entry");
        }, Row);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.filingSubject.length > 0 && this.filingChapter.length > 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('主题 (自由输入)');
                        Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(405:13)", "entry");
                        Text.fontSize(12);
                        Text.fontColor(RokuricsColors.softText);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        TextInput.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(408:13)", "entry");
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('章节 (自由输入)');
                        Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(416:13)", "entry");
                        Text.fontSize(12);
                        Text.fontColor(RokuricsColors.softText);
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        TextInput.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(419:13)", "entry");
                        TextInput.fontSize(14);
                        TextInput.fontColor(RokuricsColors.deepText);
                        TextInput.backgroundColor(RokuricsColors.glassSurface + '40');
                        TextInput.borderRadius(8);
                ...
                this.ifElseBranchUpdateFunction(2, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // Subject options
                        Row.create({ space: 6 });
                        Row.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(428:13)", "entry");
                        // Subject options
                        Row.flexShrink(0);
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        const forEachItemGenFunction = _item => {
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create(option);
                                Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(430:17)", "entry");
                                Text.fontSize(12);
                                Text.fontWeight(FontWeight.Medium);
                ...
                this.ifElseBranchUpdateFunction(3, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // Type options
                        Row.create({ space: 6 });
                        Row.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(449:13)", "entry");
                        // Type options
                        Row.flexShrink(0);
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        const forEachItemGenFunction = _item => {
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create(option);
                                Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(451:17)", "entry");
                                Text.fontSize(12);
                                Text.fontWeight(FontWeight.Medium);
            ...
            if (this.filingType || this.filingSubject || this.filingChapter || this.filingTopic) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(472:13)", "entry");
                        Text.fontSize(12);
                        Text.fontColor(RokuricsColors.aqua);
                        Text.margin({ top: 4 });
                    }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // Action buttons
            Row.create({ space: 12 });
            Row.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(479:11)", "entry");
            // Action buttons
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithChild();
            Button.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(480:13)", "entry");
            Button.layoutWeight(1);
            Button.height(48);
            Button.borderRadius(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('直接保存');
            Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(481:15)", "entry");
            Text.fontSize(15);
            Text.fontWeight(FontWeight.SemiBold);
            Text.fontColor(RokuricsColors.softText);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Button.createWithChild();
            Button.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(496:13)", "entry");
            Button.layoutWeight(1);
            Button.height(48);
            Button.borderRadius(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('保存归档');
            Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(497:15)", "entry");
            Text.fontSize(15);
            Text.fontWeight(FontWeight.SemiBold);
            Text.fontColor(Color.White);
        }, Text);
    ...
    LevelButton(label: string, value: string, enabled: boolean, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(562:5)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(label);
            Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(563:7)", "entry");
            Text.fontSize(9);
            Text.fontWeight(FontWeight.Bold);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(value || '—');
            Text.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(567:7)", "entry");
            Text.fontSize(11);
            Text.fontWeight(FontWeight.SemiBold);
    ...
    SessionBackground(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(589:5)", "entry");
            Stack.width('100%');
            Stack.height('100%');
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Circle.create();
            Circle.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(590:7)", "entry");
            Circle.width(220);
            Circle.height(220);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Circle.create();
            Circle.debugLine("entry/src/main/ets/pages/RecordingSessionPage.ets(596:7)", "entry");
            Circle.width(260);
            Circle.height(260);
